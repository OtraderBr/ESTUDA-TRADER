...
- [ ] **Step 3: Atualizar `dataService.js` para incluir o campo novo**
...
- [ ] **Step 1: Criar o arquivo JSON de mapeamento**
...
- [ ] **Step 2: Expor no `window` para uso no console**
...
- [ ] **Step 1: Localizar o trecho atual do módulo no concept-detail**
...
- [ ] **Step 2: Substituir pelo novo componente**
...
- [ ] **Step 3: Adicionar listener no `course-badge-btn`**
...
- [ ] **Step 1: Adicionar as funções CRUD no final de `dataService.js`**
...
- [ ] **Step 1: Criar o módulo `js/notes.js`**
...
- [ ] **Step 1: Adicionar import e case no `app.js`**
...
- [ ] **Step 3: Adicionar estilos de modo foco em `css/style.css`**
...
- [ ] **Step 1: Adicionar botão de modo foco no header da aba Descrição**
...
- [ ] **Step 2: Adicionar listener de modo foco**
...
- [ ] **Step 1: Adicionar script D3 no `<head>`**
...
- [ ] **Step 1: Verificar o estado inicial em `state.js`**
...
- [ ] **Step 2: Popular no engine após carregar conceitos**
...
- [ ] **Step 3: Exportar a função `buildGraphDataFromConcepts` de `graph.js`**
...
- [ ] Campo `aula_curso` existe no Supabase + `dataService.js` o carrega
- [ ] `course-mapping.json` criado e válido
- [ ] `runCourseMapper()` executado e conceitos atualizados no banco
- [ ] Badge módulo/aula aparece no concept-detail com link de navegação
...
- [ ] Sidebar tem: Notas + Grafo nos itens de nav
